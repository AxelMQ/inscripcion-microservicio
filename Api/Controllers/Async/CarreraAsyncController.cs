// Api/Controllers/CarreraAsyncController.cs
...
public class CarreraAsyncController : ControllerBase
{
  ...
  public CarreraAsyncController(HotHangfireServerManager queues, IJobResultRepository results)
  {
    _queues = queues;
    _results = results;
  }
  ...
  [HttpPost]
  public Task<IActionResult> Create([FromRoute] string queue, [FromBody] CarreraCreateDto dto)
  ...
  [HttpPut("{id:int}")]
  public Task<IActionResult> Update([FromRoute] string queue, [FromRoute] int id, [FromBody] CarreraUpdateDto dto)
